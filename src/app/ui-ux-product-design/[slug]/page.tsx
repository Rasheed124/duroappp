...
import { getSingleUiUxProductDesigns } from "../../../../sanity/utils/sanity.utils";
...
async function UiUxProductProject({ params }: Props) {

     let project = null;

     try {
       project = await getSingleUiUxProductDesigns(params.slug);
     } catch (error) {
...
export default UiUxProductProject;
